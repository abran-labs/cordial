...
With `CORDIAL_SECRET_STORE=file`, clicking Play on Roblox's website checks the
browser account and launches its matching saved Cordial profile automatically.
...
Other secret backends retain manual selection.
